...
/**
 * 单元测试的类   //Configuration译 配置 configure 安装// transaction 译 事务
 */
public class MainTest {
    ...
    public void init() {
        /*1.构建配置对象*/
        Configuration config = new Configuration();    //配置
        /*2.默认加载src下的配置文件Hibernate.cfg.xml*/
        config.configure();                             //配置安装
        sessionFactory = config.buildSessionFactory();  //建造会话工厂
    ...
    public void test1(){
        ...
        student.setClazz(clazz);//学生绑定班级 多的.少的
